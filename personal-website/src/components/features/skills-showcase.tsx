...
const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    context:
      'Building agentic AI with OpenAI, Claude, and CrewAI. Running local models with Ollama and MLX, creating multi-agent systems with LangGraph, and using vector databases like Pinecone and ChromaDB for RAG pipelines.',
    icon: '🤖',
  },
  {
    ...
    <section className="py-12 md:py-24 bg-muted/40 w-full">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-bold tracking-tight mb-4">What I Use</h2>
          ...
          {skillCategories.map((category) => (
            <Card key={category.title} className="h-full">
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground leading-relaxed">{category.context}</p>
          ...
          <Card className="max-w-3xl mx-auto bg-muted/20 border-dashed">
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                The tech world moves fast, and I enjoy keeping up. Currently exploring: agentic AI
                frameworks, voice AI with ElevenLabs, and developing AI curriculum for the next
                generation of developers. If you're working on something interesting, I'd love to
                hear about it.
              </p>
            </CardContent>
          </Card>
