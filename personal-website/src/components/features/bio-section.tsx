        ...
        <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground md:text-lg/relaxed">
              ...
              helps clear my head and honestly leads to some of my best ideas.
            </p>
          </div>
          <div className="flex justify-center">
            <div className="w-full max-w-xs sm:max-w-md rounded-lg bg-muted flex items-center justify-center text-muted-foreground">
              <Image
